...
class Enroll extends Model
{
    ...
    public function student(){
        ...
        // // Method 5         join(sec table,sec table primarykey , compare , pri table fk key)
        ...
        // }
         ...
         // Method 6         join(sec table,sec table primarykey , compare , pri table fk key)
        ...
        // Method 7         join(sec table,sec table primarykey , compare , pri table fk key)
        ...
        // }
         ...
         // // Method 8         join(sec table,sec table primarykey , compare , pri table fk key)
        ...
        // // Method 9        join(sec table,sec table primarykey , compare , pri table fk key)
