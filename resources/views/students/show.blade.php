                                ...
                                <div class="row g-0 mb-2">
                                    ...
                                    <div class="col ps-3">
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                <div class="">{{ date('d M Y', strtotime($student->updated_at)) }} |
                                                    {{ date('h:i:s A', strtotime($student->updated_at)) }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row g-0 mb-2">
                                    ...
                                    <div class="col ps-3">
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                <div class="">
                                                    {{ date('d M Y h:i:s A', strtotime($student->updated_at)) }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <ul class="nav">
                            <li class="nav-item">
                                <button type="button" id="autoclick" class="tablinks"
                                    onclick="gettab(event,'follower')">Follower</button>
                            </li>
                            <li class="nav-item">
                                <button type="button" class="tablinks"
                                    onclick="gettab(event,'following')">Following</button>
                            </li>
                            <li class="nav-item">
                                <button type="button" class="tablinks"
                                    onclick="gettab(event,'liked')">Liked</button>
                            </li>
                            <li class="nav-item">
                                <button type="button" class="tablinks"
                                    onclick="gettab(event,'remark')">Remark</button>
                            </li>
